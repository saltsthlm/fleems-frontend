...
export default function MainNavigation() {
  ...
  if (!isMobile) {
    return (
      <header className="order-first sticky top-0 bg-button grid grid-flow-col grid-cols-center3 justify-between z-30 p-4 px-12 drop-shadow-lg gap-5">
  ...
  return (
    <footer className="mt-auto flex justify-around bg-button p-2 text-sm text-center items-end [&>a>img]:mx-auto [&>a>img]:h-7 sticky bottom-0 z-30">
      <Link to="/">
